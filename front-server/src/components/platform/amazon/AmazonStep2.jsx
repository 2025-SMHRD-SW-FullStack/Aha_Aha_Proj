    ...
    return (
        <div>
            ...
            <div className={styles.infoBox}>
                · 아마존 검색창 하단의 <strong>[I’m adding a product not sold on Amazon]</strong> 버튼 또는 
                <div style={{marginLeft:'12px'}}>카탈로그 검색 결과창 좌측 하단의 <strong>[Create a new listing]</strong> 버튼을 클릭하여 새 상품</div> 
                <div style={{marginLeft:'12px'}}>등록을 시작</div>
            </div>
            <br />
            ...
            <h3>✅ 기존 상품 등록하러 가기</h3>
            <div className={styles.infoBox}>
                · 이미 아마존에 등록된 상품인지 확인하기 위해 검색창에 <strong>제품명, UPC, EAN, ISBN</strong> 
                <div style={{marginLeft:'12px'}}>등을 입력</div>
